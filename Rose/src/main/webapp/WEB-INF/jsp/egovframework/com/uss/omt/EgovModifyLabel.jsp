  ...
  <div class="Container"> 
    ...
    <div class="Content"> 
      ...
      <div class="content_box" id="org_content_box">
		...
		<p class="tab_title float_left"><spring:message code="appvl.label.label.modify"/></p>
		<div class="ui_btn_rapper float_right">
			<a href="javascript:modifyLabel()" class="btn_color3"><spring:message code="common.button.apply"/></a>
			<a href="javascript:historyBack()" class="btn_color2"><spring:message code="common.button.cancel"/></a>
		</div>
		<div class="table_rapper">
			<form id="label_form" name="label_form" action="<c:out value="${pageContext.servletContext.contextPath}"/>/modifyLabel.do" method="post">
			<input type="hidden" name="labelID" value="<c:out value="${label.labelId}"/>">
			<table summary="" class="board_width_borderNone">
				...
				<tbody>
					<tr>
						...
						<td colspan="3"><div class="ui_input_text"><input type="text" value="<c:out value="${label.labelNm}"/>" name="labelNm" id="labelNm"/></div></td>
					</tr>
					<tr>
						<th scope="row"><label for="label_2"><spring:message code="common.location.label.location"/></label></th>
						<td>
							<div class="ui_input_text">
							<input type="text" value="" name="targetLabelNm" id="targetLabelNm"/>
							<input type="hidden" value="" name="targetLabelID" id="targetLabelID"/>
							</div>
						</td>
