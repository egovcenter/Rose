								...
								<table summary="" class="board_width_borderNone">
									...
									<tbody>
										<tr>
											...
											<td colspan="2"><div class="ui_input_text"><input type="text" name="draft_title" value="<c:out value="${doc.docTitle}"/>" <c:if test="${doc.docType eq 'DT03'}">readonly="readonly"</c:if> /></div></td>
										</tr>
										<tr>
											<th scope="row"><label for="label_2"><spring:message code="appvl.documet.label.label"/></label></th>
											<td <c:if test="${doc.docType eq 'DT03'}">colspan="2"</c:if>><div class="ui_input_text"><input type="text" value="<c:out value="${label.labelNm}"/>" id="selectlabelNm" readonly="readonly"/><input type="hidden" value="<c:out value="${doc.lbelId}"/>" id="selectlabelId"/></div></td>
												...
												<table summary="/No/Attochment/Title/Poster/Post Date/Expire date" class="board_type_height mb20" id="signer_list_table">
													...
													<tr class="unsortable">
														...
														<td>
															...
															<c:if test="${signer.signState ne 'SS03'}">
