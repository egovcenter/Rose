...
public interface EgovUserManageService  {
    ...
    public void deleteUserList(String idList) throws Exception;
	/**
	 ...
	 * @throws Exception
	 */
	public UserManageVO getUser(String emplyrId) throws Exception;
	
	public UserManageVO getUser(UserManageVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<?> getUserList(UserDefaultVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int getUserCnt(UserDefaultVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public UserManageVO getPassword(UserManageVO passVO) throws Exception;
