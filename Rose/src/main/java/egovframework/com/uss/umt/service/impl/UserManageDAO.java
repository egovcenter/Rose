...
public class UserManageDAO extends EgovComAbstractDAO{
    ...
    public String insertUser(UserManageVO userManageVO){
        insert("userManageDAO.insertAuthorityOfUser", userManageVO);
     ...
     */
    public UserManageVO selectUser(UserManageVO vo) {
        return (UserManageVO) select("userManageDAO.selectUser_S", vo);
    }
    ...
    public List<UserManageVO> selectUserInfList(UserManageVO userSearchVO){
        return (List<UserManageVO>) list("userManageDAO.selectUserInfList", userSearchVO);
    }
    ...
    public int selectUserCntByPosition(String posiId) {
        return (Integer)select("userManageDAO.selectUserCntByPosition", posiId);
    }
    
    public int selectUserCntByDuty(String dutyId) {
        return (Integer)select("userManageDAO.selectUserCntByDuty", dutyId);
    }
}