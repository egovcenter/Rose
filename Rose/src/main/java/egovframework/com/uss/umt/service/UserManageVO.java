...
public class UserManageVO extends UserDefaultVO{
	...
	/**
	 * User Type(System admin/Admin/Department admin/User)
	 */
	private String userType="";
	
	private String userAbsF="";
	...
	public void setComapnyId(String id) {
	    this.companyId = id;
	}
	...
	public void setPositionNm(String name) {
	    this.positionNm = name;
	}
