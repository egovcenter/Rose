...
public class BBSAttributeManageDAO extends EgovComAbstractDAO {
    ...
    // TBS added by paul 20160202 start
    /**
     * Retrieve tree information of BBS
     * 
     * @param vo
     * @return
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public List<TreeNodeVO> selectBBSTreeList() throws Exception {
	return (List<TreeNodeVO>) list("BBSAttributeManageDAO.selectBBSTreeList");
    }
    // TBS added by paul 20160202 end
}
